...
struct InformacaoMapeamentoListRow: View {
...
struct InformacaoMapeamentoListRow_Previews: PreviewProvider {
    ...
    static var previews: some View {
        InformacaoMapeamentoListRow(label: "Mapeamento", value: 1)
    }
}
